...
The makefile creates a tester program shared-test; you can run it with the script run.sh, to verify that make worked (that is, that the library built and the program runs). Run it thus: ./run.sh
