...
//Before first call to SSDL_Display::Instance()... the instance_ must be null
// Then, when we call Instance(), things get initialized and instance_ takes a value
SSDL_Display* SSDL_Display::instance_ = nullptr; 
