...
char myToupper(char c) //WSB: I do NOT like having to do this.  Won't work with alternate keyboard configurations.
//what do I do so that the character returned will be the right one?!
{
